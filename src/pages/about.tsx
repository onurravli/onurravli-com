        ...
        <div className={styles.main}>
            <div className={styles.section}>
                ...
                <p className={styles.aboutMe} style={poppins.style}>
                    ...
                    skill set in various programming languages, including C/C++, JavaScript/TypeScript, Python, Java,
                ...
                <p className={styles.aboutMe} style={poppins.style}>
                    ...
                    I am an active member of various organizations, including UCTEA Chamber of Electrical Engineering,
                ...
                <p className={styles.aboutMe} style={poppins.style}>
                    ...
                    Overall, I am passionate about technology and eager to contribute my skills to meaningful projects.
